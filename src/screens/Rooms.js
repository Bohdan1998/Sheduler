  ...
  render() {
    return (
      ...
      <TouchableOpacity style={styles.buttoncontainer}>
         <Text style={styles.textbotton}>Кімната</Text>
         </TouchableOpacity>
         <TouchableOpacity style={styles.buttoncontainer}>
         <Text style={styles.textbotton}>Кімната</Text>
         </TouchableOpacity>
      ...
      <View style={{width:100,height:100,backgroundColor: 'rgba(247, 194, 15, 0.2)',position:'relative',borderRadius:60,marginTop:80,left:220}}>
